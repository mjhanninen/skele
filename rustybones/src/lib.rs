...
const FINGERPRINT_SALT: [u8; 32] = [
    0x15, 0x01, 0x8a, 0x3e, 0x8e, 0x79, 0x28, 0x71, 0x43, 0x70, 0xf7, 0x51, 0x1c, 0x3b, 0xd5, 0xce,
    0x85, 0x2b, 0x6f, 0x91, 0x52, 0xc2, 0xb9, 0xab, 0xdb, 0x99, 0xaa, 0xd7, 0x9f, 0xc5, 0x51, 0x20,
];
...
pub mod base32 {
    ...
    const CROCKFORD_TRANSLATION_TABLE: [u8; 32] = [
        ...
        0x66, 0x67, 0x68, 0x6a, 0x6b, 0x6d, 0x6e, 0x70, 0x71, 0x72, 0x73, 0x74, 0x76, 0x77, 0x78,
        0x79, 0x7a,
    ];
...
mod tests {
    ...
    fn it_works() {
        ...
        assert!(rc == Ok(()));
        let correct = [
            0x17, 0xa8, 0xea, 0x56, 0x34, 0xad, 0x5e, 0x06, 0x0f, 0xac, 0xab, 0x88, 0x44, 0x3a,
            0xf9, 0x81, 0x1d, 0x5d, 0x5a, 0x94, 0x77, 0x42, 0x7f, 0x53, 0x3d, 0xa9, 0x93, 0xdb,
            0x82, 0xad, 0x93, 0x4c,
        ];
        assert!(key == correct);
    }
